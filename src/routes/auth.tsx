  ...
  return (
    <>
      <button
        ...
        className="w-full flex items-center justify-center gap-2 rounded-md border border-border bg-background px-4 py-2 text-sm font-medium hover:bg-muted transition"
      >
        <svg className="size-4" viewBox="0 0 48 48" aria-hidden="true">
          ...
          <path fill="#4CAF50" d="M24 43.5c5 0 9.5-1.7 13-4.6l-6-5.1c-1.9 1.3-4.4 2.1-7 2.1-5.3 0-9.7-3.1-11.3-7.5l-6.6 5.1C9.4 39 16.1 43.5 24 43.5z"/>
          <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.3 4-4.2 5.3l6 5.1c-.4.4 6.4-4.6 6.4-14.4 0-1.2-.1-2.3-.4-3.5z"/>
        </svg>
        {label}
      </button>
